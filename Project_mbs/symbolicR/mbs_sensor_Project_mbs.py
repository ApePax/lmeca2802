...
# Sensor Kinematics
  ...
  if (isens == 1): 
    ...
    RLcp1_14 = s.dpt[3,5]*S3
    RLcp1_34 = s.dpt[3,5]*C3
    POcp1_14 = RLcp1_14+q[1]
    POcp1_24 = POcp1_23+s.dpt[2,5]
    POcp1_34 = POcp1_32+RLcp1_34
    ORcp1_14 = RLcp1_34*qd[3]
    ORcp1_34 = -RLcp1_14*qd[3]
    VIcp1_14 = ORcp1_14+qd[1]
    VIcp1_34 = ORcp1_34+qd[2]
    ACcp1_14 = qdd[1]+ORcp1_34*qd[3]+RLcp1_34*qdd[3]
    ACcp1_34 = qdd[2]-ORcp1_14*qd[3]-RLcp1_14*qdd[3]
    sens.P[1] = POcp1_14
    sens.P[2] = POcp1_24
    sens.P[3] = POcp1_34
    sens.R[1,1] = C3
  ...
  if (isens == 11): 
    ...
    sens.P[2] = POcp11_29
    sens.P[3] = POcp11_39
    sens.R[1,1] = ROcp11_113
    sens.R[1,3] = ROcp11_313
    sens.R[2,2] = (1.0)
    sens.R[3,1] = ROcp11_713
    sens.R[3,3] = ROcp11_913
    sens.V[1] = VIcp11_19
    sens.V[2] = 0
    sens.V[3] = VIcp11_39
    sens.OM[1] = 0
