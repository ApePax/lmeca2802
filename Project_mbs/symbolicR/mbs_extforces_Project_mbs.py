...
# Sensor Kinematics
    ...
    RLcp2_19 = ROcp2_18*s.dpt[1,8]+ROcp2_78*s.dpt[3,8]
    RLcp2_39 = ROcp2_38*s.dpt[1,8]+ROcp2_98*s.dpt[3,8]
    POcp2_19 = POcp2_18+RLcp2_19
    POcp2_29 = POcp2_24+s.dpt[2,8]
    ...
    RLcp3_19 = ROcp3_18*s.dpt[1,9]+ROcp3_78*s.dpt[3,9]
    RLcp3_39 = ROcp3_38*s.dpt[1,9]+ROcp3_98*s.dpt[3,9]
    POcp3_19 = POcp3_18+RLcp3_19
    POcp3_29 = POcp3_24+s.dpt[2,9]
    ...
    RLcp4_19 = ROcp4_78*s.dpt[3,10]
    RLcp4_39 = ROcp4_98*s.dpt[3,10]
    ...
    RLcp5_19 = ROcp5_18*s.dpt[1,11]+ROcp5_78*s.dpt[3,11]
    RLcp5_39 = ROcp5_38*s.dpt[1,11]+ROcp5_98*s.dpt[3,11]
    POcp5_19 = POcp5_18+RLcp5_19
    POcp5_29 = POcp5_24+s.dpt[2,11]
    ...
    ROcp6_17 = ROcp6_15*C7-ROcp6_75*S7
    ROcp6_37 = ROcp6_35*C7-ROcp6_95*S7
    ROcp6_77 = ROcp6_15*S7+ROcp6_75*C7
    ROcp6_97 = ROcp6_35*S7+ROcp6_95*C7
    ...
    VIcp6_14 = qd[1]+ORcp6_14+qd[4]*S3
    VIcp6_34 = qd[2]+ORcp6_34+qd[4]*C3
    ACcp6_14 = qdd[1]+qd[3]*ORcp6_34+(2.0)*qd[3]*qd[4]*C3+qdd[3]*RLcp6_34+qdd[4]*S3
    ACcp6_34 = qdd[2]-qd[3]*ORcp6_14-(2.0)*qd[3]*qd[4]*S3-qdd[3]*RLcp6_14+qdd[4]*C3
    OMcp6_25 = qd[3]+qd[5]
    ...
    VIcp6_16 = ORcp6_16+VIcp6_14+qd[6]*ROcp6_75
    VIcp6_36 = ORcp6_36+VIcp6_34+qd[6]*ROcp6_95
    ACcp6_16 = ACcp6_14+(2.0)*qd[6]*OMcp6_25*ROcp6_95+qdd[6]*ROcp6_75+OMcp6_25*ORcp6_36+OPcp6_25*RLcp6_36
    ACcp6_36 = ACcp6_34-(2.0)*qd[6]*OMcp6_25*ROcp6_75+qdd[6]*ROcp6_95-OMcp6_25*ORcp6_16-OPcp6_25*RLcp6_16
    OMcp6_27 = qd[7]+OMcp6_25
    OPcp6_27 = qdd[7]+OPcp6_25
    RLcp6_18 = ROcp6_77*s.dpt[3,7]
    RLcp6_38 = ROcp6_97*s.dpt[3,7]
    POcp6_18 = POcp6_16+RLcp6_18
    POcp6_38 = POcp6_36+RLcp6_38
    OMcp6_28 = qd[8]+OMcp6_27
    ORcp6_18 = OMcp6_27*RLcp6_38
    ORcp6_38 = -OMcp6_27*RLcp6_18
    VIcp6_18 = ORcp6_18+VIcp6_16
    VIcp6_38 = ORcp6_38+VIcp6_36
    OPcp6_28 = qdd[8]+OPcp6_27
    ACcp6_18 = ACcp6_16+OMcp6_27*ORcp6_38+OPcp6_27*RLcp6_38
    ACcp6_38 = ACcp6_36-OMcp6_27*ORcp6_18-OPcp6_27*RLcp6_18
    RLcp6_19 = ROcp6_18*s.dpt[1,12]+ROcp6_78*s.dpt[3,12]
    RLcp6_39 = ROcp6_38*s.dpt[1,12]+ROcp6_98*s.dpt[3,12]
    POcp6_19 = POcp6_18+RLcp6_19
    POcp6_29 = POcp6_24+s.dpt[2,12]
    ...
    RLcp7_19 = ROcp7_113*s.dpt[1,15]+ROcp7_713*s.dpt[3,15]
    RLcp7_39 = ROcp7_313*s.dpt[1,15]+ROcp7_913*s.dpt[3,15]
    POcp7_19 = POcp7_18+RLcp7_19
    POcp7_29 = POcp7_24+s.dpt[2,15]
    ...
    RLcp8_19 = ROcp8_113*s.dpt[1,16]+ROcp8_713*s.dpt[3,16]
    RLcp8_39 = ROcp8_313*s.dpt[1,16]+ROcp8_913*s.dpt[3,16]
    POcp8_19 = POcp8_18+RLcp8_19
    POcp8_29 = POcp8_24+s.dpt[2,16]
    ...
    RLcp9_19 = ROcp9_713*s.dpt[3,17]
    RLcp9_39 = ROcp9_913*s.dpt[3,17]
    ...
    RLcp10_19 = ROcp10_113*s.dpt[1,18]+ROcp10_713*s.dpt[3,18]
    RLcp10_39 = ROcp10_313*s.dpt[1,18]+ROcp10_913*s.dpt[3,18]
    POcp10_19 = POcp10_18+RLcp10_19
    POcp10_29 = POcp10_24+s.dpt[2,18]
    ...
    ROcp11_112 = ROcp11_110*C12-ROcp11_710*S12
    ROcp11_312 = ROcp11_310*C12-ROcp11_910*S12
    ROcp11_712 = ROcp11_110*S12+ROcp11_710*C12
    ROcp11_912 = ROcp11_310*S12+ROcp11_910*C12
    ROcp11_113 = ROcp11_112*C13-ROcp11_712*S13
    ROcp11_313 = ROcp11_312*C13-ROcp11_912*S13
    ROcp11_713 = ROcp11_112*S13+ROcp11_712*C13
    ROcp11_913 = ROcp11_312*S13+ROcp11_912*C13
    POcp11_32 = q[2]+s.dpt[3,1]
    POcp11_23 = s.dpt[2,2]+s.dpt[2,3]
    RLcp11_14 = Dz93*S3
    RLcp11_34 = Dz93*C3
    POcp11_14 = q[1]+RLcp11_14
    POcp11_24 = POcp11_23+s.dpt[2,5]
    POcp11_34 = POcp11_32+RLcp11_34
    ORcp11_14 = qd[3]*RLcp11_34
    ORcp11_34 = -qd[3]*RLcp11_14
    VIcp11_14 = qd[1]+ORcp11_14+qd[9]*S3
    VIcp11_34 = qd[2]+ORcp11_34+qd[9]*C3
    ACcp11_14 = qdd[1]+qd[3]*ORcp11_34+(2.0)*qd[3]*qd[9]*C3+qdd[3]*RLcp11_34+qdd[9]*S3
    ACcp11_34 = qdd[2]-qd[3]*ORcp11_14-(2.0)*qd[3]*qd[9]*S3-qdd[3]*RLcp11_14+qdd[9]*C3
    ...
    VIcp11_16 = ORcp11_16+VIcp11_14+qd[11]*ROcp11_710
    VIcp11_36 = ORcp11_36+VIcp11_34+qd[11]*ROcp11_910
    ACcp11_16 = ACcp11_14+(2.0)*qd[11]*OMcp11_25*ROcp11_910+qdd[11]*ROcp11_710+OMcp11_25*ORcp11_36+OPcp11_25*RLcp11_36
    ACcp11_36 = ACcp11_34-(2.0)*qd[11]*OMcp11_25*ROcp11_710+qdd[11]*ROcp11_910-OMcp11_25*ORcp11_16-OPcp11_25*RLcp11_16
    OMcp11_27 = qd[12]+OMcp11_25
    OPcp11_27 = qdd[12]+OPcp11_25
    RLcp11_18 = ROcp11_712*s.dpt[3,14]
    RLcp11_38 = ROcp11_912*s.dpt[3,14]
    POcp11_18 = POcp11_16+RLcp11_18
    POcp11_38 = POcp11_36+RLcp11_38
    OMcp11_28 = qd[13]+OMcp11_27
    ORcp11_18 = OMcp11_27*RLcp11_38
    ORcp11_38 = -OMcp11_27*RLcp11_18
    VIcp11_18 = ORcp11_18+VIcp11_16
    VIcp11_38 = ORcp11_38+VIcp11_36
    OPcp11_28 = qdd[13]+OPcp11_27
    ACcp11_18 = ACcp11_16+OMcp11_27*ORcp11_38+OPcp11_27*RLcp11_38
    ACcp11_38 = ACcp11_36-OMcp11_27*ORcp11_18-OPcp11_27*RLcp11_18
    RLcp11_19 = ROcp11_113*s.dpt[1,19]+ROcp11_713*s.dpt[3,19]
    RLcp11_39 = ROcp11_313*s.dpt[1,19]+ROcp11_913*s.dpt[3,19]
    POcp11_19 = POcp11_18+RLcp11_19
    POcp11_29 = POcp11_24+s.dpt[2,19]
    POcp11_39 = POcp11_38+RLcp11_39
    ORcp11_19 = OMcp11_28*RLcp11_39
    ORcp11_39 = -OMcp11_28*RLcp11_19
    VIcp11_19 = ORcp11_19+VIcp11_18
    VIcp11_39 = ORcp11_39+VIcp11_38
    ACcp11_19 = ACcp11_18+OMcp11_28*ORcp11_39+OPcp11_28*RLcp11_39
    ACcp11_39 = ACcp11_38-OMcp11_28*ORcp11_19-OPcp11_28*RLcp11_19
    PxF10[1] = POcp11_19
    PxF10[2] = POcp11_29
    PxF10[3] = POcp11_39
    RxF10[1,1] = ROcp11_113
    RxF10[1,3] = ROcp11_313
    RxF10[2,2] = (1.0)
    RxF10[3,1] = ROcp11_713
    RxF10[3,3] = ROcp11_913
    VxF10[1] = VIcp11_19
    VxF10[2] = 0
    VxF10[3] = VIcp11_39
    OMxF10[1] = 0
...
# Sensor Forces 
    ...
    trqext_1_8_1 = xtrq12-xfrc22*(SWr1[9]-s.l[3,8])+xfrc32*SWr1[8]
    trqext_2_8_1 = xtrq22+xfrc12*(SWr1[9]-s.l[3,8])-xfrc32*SWr1[7]
    trqext_3_8_1 = xtrq32-xfrc12*SWr1[8]+xfrc22*SWr1[7]
    xfrc13 = RxF2[1,1]*SWr2[1]+RxF2[1,3]*SWr2[3]
    xfrc23 = RxF2[2,2]*SWr2[2]
    xfrc33 = RxF2[3,1]*SWr2[1]+RxF2[3,3]*SWr2[3]
    frcext_1_8_2 = xfrc12+xfrc13
    frcext_2_8_2 = xfrc22+xfrc23
    frcext_3_8_2 = xfrc32+xfrc33
    xtrq13 = RxF2[1,1]*SWr2[4]+RxF2[1,3]*SWr2[6]
    xtrq23 = RxF2[2,2]*SWr2[5]
    xtrq33 = RxF2[3,1]*SWr2[4]+RxF2[3,3]*SWr2[6]
    trqext_1_8_2 = trqext_1_8_1+xtrq13-xfrc23*(SWr2[9]-s.l[3,8])+xfrc33*SWr2[8]
    trqext_2_8_2 = trqext_2_8_1+xtrq23+xfrc13*(SWr2[9]-s.l[3,8])-xfrc33*SWr2[7]
    trqext_3_8_2 = trqext_3_8_1+xtrq33-xfrc13*SWr2[8]+xfrc23*SWr2[7]
    xfrc14 = RxF3[1,1]*SWr3[1]+RxF3[1,3]*SWr3[3]
    xfrc24 = RxF3[2,2]*SWr3[2]
    xfrc34 = RxF3[3,1]*SWr3[1]+RxF3[3,3]*SWr3[3]
    frcext_1_8_3 = frcext_1_8_2+xfrc14
    frcext_2_8_3 = frcext_2_8_2+xfrc24
    frcext_3_8_3 = frcext_3_8_2+xfrc34
    xtrq14 = RxF3[1,1]*SWr3[4]+RxF3[1,3]*SWr3[6]
    xtrq24 = RxF3[2,2]*SWr3[5]
    xtrq34 = RxF3[3,1]*SWr3[4]+RxF3[3,3]*SWr3[6]
    trqext_1_8_3 = trqext_1_8_2+xtrq14-xfrc24*(SWr3[9]-s.l[3,8])+xfrc34*SWr3[8]
    trqext_2_8_3 = trqext_2_8_2+xtrq24+xfrc14*(SWr3[9]-s.l[3,8])-xfrc34*SWr3[7]
    trqext_3_8_3 = trqext_3_8_2+xtrq34-xfrc14*SWr3[8]+xfrc24*SWr3[7]
    xfrc15 = RxF4[1,1]*SWr4[1]+RxF4[1,3]*SWr4[3]
    xfrc25 = RxF4[2,2]*SWr4[2]
    xfrc35 = RxF4[3,1]*SWr4[1]+RxF4[3,3]*SWr4[3]
    frcext_1_8_4 = frcext_1_8_3+xfrc15
    frcext_2_8_4 = frcext_2_8_3+xfrc25
    frcext_3_8_4 = frcext_3_8_3+xfrc35
    xtrq15 = RxF4[1,1]*SWr4[4]+RxF4[1,3]*SWr4[6]
    xtrq25 = RxF4[2,2]*SWr4[5]
    xtrq35 = RxF4[3,1]*SWr4[4]+RxF4[3,3]*SWr4[6]
    trqext_1_8_4 = trqext_1_8_3+xtrq15-xfrc25*(SWr4[9]-s.l[3,8])+xfrc35*SWr4[8]
    trqext_2_8_4 = trqext_2_8_3+xtrq25+xfrc15*(SWr4[9]-s.l[3,8])-xfrc35*SWr4[7]
    trqext_3_8_4 = trqext_3_8_3+xtrq35-xfrc15*SWr4[8]+xfrc25*SWr4[7]
    xfrc16 = RxF5[1,1]*SWr5[1]+RxF5[1,3]*SWr5[3]
    xfrc26 = RxF5[2,2]*SWr5[2]
    xfrc36 = RxF5[3,1]*SWr5[1]+RxF5[3,3]*SWr5[3]
    frcext_1_8_5 = frcext_1_8_4+xfrc16
    frcext_2_8_5 = frcext_2_8_4+xfrc26
    frcext_3_8_5 = frcext_3_8_4+xfrc36
    xtrq16 = RxF5[1,1]*SWr5[4]+RxF5[1,3]*SWr5[6]
    xtrq26 = RxF5[2,2]*SWr5[5]
    xtrq36 = RxF5[3,1]*SWr5[4]+RxF5[3,3]*SWr5[6]
    trqext_1_8_5 = trqext_1_8_4+xtrq16-xfrc26*(SWr5[9]-s.l[3,8])+xfrc36*SWr5[8]
    trqext_2_8_5 = trqext_2_8_4+xtrq26+xfrc16*(SWr5[9]-s.l[3,8])-xfrc36*SWr5[7]
    trqext_3_8_5 = trqext_3_8_4+xtrq36-xfrc16*SWr5[8]+xfrc26*SWr5[7]
    xfrc17 = RxF6[1,1]*SWr6[1]+RxF6[1,3]*SWr6[3]
    xfrc27 = RxF6[2,2]*SWr6[2]
    xfrc37 = RxF6[3,1]*SWr6[1]+RxF6[3,3]*SWr6[3]
    xtrq17 = RxF6[1,1]*SWr6[4]+RxF6[1,3]*SWr6[6]
    xtrq27 = RxF6[2,2]*SWr6[5]
    xtrq37 = RxF6[3,1]*SWr6[4]+RxF6[3,3]*SWr6[6]
    trqext_1_13_6 = xtrq17-xfrc27*(SWr6[9]-s.l[3,13])+xfrc37*SWr6[8]
    trqext_2_13_6 = xtrq27+xfrc17*(SWr6[9]-s.l[3,13])-xfrc37*SWr6[7]
    trqext_3_13_6 = xtrq37-xfrc17*SWr6[8]+xfrc27*SWr6[7]
    xfrc18 = RxF7[1,1]*SWr7[1]+RxF7[1,3]*SWr7[3]
    xfrc28 = RxF7[2,2]*SWr7[2]
    xfrc38 = RxF7[3,1]*SWr7[1]+RxF7[3,3]*SWr7[3]
    frcext_1_13_7 = xfrc17+xfrc18
    frcext_2_13_7 = xfrc27+xfrc28
    frcext_3_13_7 = xfrc37+xfrc38
    xtrq18 = RxF7[1,1]*SWr7[4]+RxF7[1,3]*SWr7[6]
    xtrq28 = RxF7[2,2]*SWr7[5]
    xtrq38 = RxF7[3,1]*SWr7[4]+RxF7[3,3]*SWr7[6]
    trqext_1_13_7 = trqext_1_13_6+xtrq18-xfrc28*(SWr7[9]-s.l[3,13])+xfrc38*SWr7[8]
    trqext_2_13_7 = trqext_2_13_6+xtrq28+xfrc18*(SWr7[9]-s.l[3,13])-xfrc38*SWr7[7]
    trqext_3_13_7 = trqext_3_13_6+xtrq38-xfrc18*SWr7[8]+xfrc28*SWr7[7]
    xfrc19 = RxF8[1,1]*SWr8[1]+RxF8[1,3]*SWr8[3]
    xfrc29 = RxF8[2,2]*SWr8[2]
    xfrc39 = RxF8[3,1]*SWr8[1]+RxF8[3,3]*SWr8[3]
    frcext_1_13_8 = frcext_1_13_7+xfrc19
    frcext_2_13_8 = frcext_2_13_7+xfrc29
    frcext_3_13_8 = frcext_3_13_7+xfrc39
    xtrq19 = RxF8[1,1]*SWr8[4]+RxF8[1,3]*SWr8[6]
    xtrq29 = RxF8[2,2]*SWr8[5]
    xtrq39 = RxF8[3,1]*SWr8[4]+RxF8[3,3]*SWr8[6]
    trqext_1_13_8 = trqext_1_13_7+xtrq19-xfrc29*(SWr8[9]-s.l[3,13])+xfrc39*SWr8[8]
    trqext_2_13_8 = trqext_2_13_7+xtrq29+xfrc19*(SWr8[9]-s.l[3,13])-xfrc39*SWr8[7]
    trqext_3_13_8 = trqext_3_13_7+xtrq39-xfrc19*SWr8[8]+xfrc29*SWr8[7]
    xfrc110 = RxF9[1,1]*SWr9[1]+RxF9[1,3]*SWr9[3]
    xfrc210 = RxF9[2,2]*SWr9[2]
    xfrc310 = RxF9[3,1]*SWr9[1]+RxF9[3,3]*SWr9[3]
    frcext_1_13_9 = frcext_1_13_8+xfrc110
    frcext_2_13_9 = frcext_2_13_8+xfrc210
    frcext_3_13_9 = frcext_3_13_8+xfrc310
    xtrq110 = RxF9[1,1]*SWr9[4]+RxF9[1,3]*SWr9[6]
    xtrq210 = RxF9[2,2]*SWr9[5]
    xtrq310 = RxF9[3,1]*SWr9[4]+RxF9[3,3]*SWr9[6]
    trqext_1_13_9 = trqext_1_13_8+xtrq110-xfrc210*(SWr9[9]-s.l[3,13])+xfrc310*SWr9[8]
    trqext_2_13_9 = trqext_2_13_8+xtrq210+xfrc110*(SWr9[9]-s.l[3,13])-xfrc310*SWr9[7]
    trqext_3_13_9 = trqext_3_13_8+xtrq310-xfrc110*SWr9[8]+xfrc210*SWr9[7]
    xfrc111 = RxF10[1,1]*SWr10[1]+RxF10[1,3]*SWr10[3]
    xfrc211 = RxF10[2,2]*SWr10[2]
    xfrc311 = RxF10[3,1]*SWr10[1]+RxF10[3,3]*SWr10[3]
    frcext_1_13_10 = frcext_1_13_9+xfrc111
    frcext_2_13_10 = frcext_2_13_9+xfrc211
    frcext_3_13_10 = frcext_3_13_9+xfrc311
    xtrq111 = RxF10[1,1]*SWr10[4]+RxF10[1,3]*SWr10[6]
    xtrq211 = RxF10[2,2]*SWr10[5]
    xtrq311 = RxF10[3,1]*SWr10[4]+RxF10[3,3]*SWr10[6]
    trqext_1_13_10 = trqext_1_13_9+xtrq111-xfrc211*(SWr10[9]-s.l[3,13])+xfrc311*SWr10[8]
    trqext_2_13_10 = trqext_2_13_9+xtrq211+xfrc111*(SWr10[9]-s.l[3,13])-xfrc311*SWr10[7]
    trqext_3_13_10 = trqext_3_13_9+xtrq311-xfrc111*SWr10[8]+xfrc211*SWr10[7]
 
# Symbolic model output

    frc[1,8] = s.frc[1,8]+frcext_1_8_5
    frc[2,8] = s.frc[2,8]+frcext_2_8_5
    frc[3,8] = s.frc[3,8]+frcext_3_8_5
    trq[1,8] = s.trq[1,8]+trqext_1_8_5
    trq[2,8] = s.trq[2,8]+trqext_2_8_5
    trq[3,8] = s.trq[3,8]+trqext_3_8_5
    frc[1,13] = s.frc[1,13]+frcext_1_13_10
    frc[2,13] = s.frc[2,13]+frcext_2_13_10
    frc[3,13] = s.frc[3,13]+frcext_3_13_10
    trq[1,13] = s.trq[1,13]+trqext_1_13_10
    trq[2,13] = s.trq[2,13]+trqext_2_13_10
    trq[3,13] = s.trq[3,13]+trqext_3_13_10
