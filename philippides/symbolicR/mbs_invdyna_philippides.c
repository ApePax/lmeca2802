...
{
#include "mbs_invdyna_philippides.h"
...
BS94 = -qd[3]*qd[3];
ALPHA14 = ALPHA13+q[4]*qdd[3]+(2.0)*qd[3]*qd[4];
ALPHA34 = qdd[4]+ALPHA33+q[4]*BS93;
OM25 = qd[3]+qd[5];
OMp25 = qdd[3]+qdd[5];
BS95 = -OM25*OM25;
...
BS96 = -OM25*OM25;
ALPHA16 = ALPHA15+q[6]*OMp25+(2.0)*qd[6]*OM25;
ALPHA36 = qdd[6]+ALPHA35+q[6]*BS95;
OM27 = qd[7]+OM25;
OMp27 = qdd[7]+OMp25;
BS97 = -OM27*OM27;
...
BS99 = -qd[3]*qd[3];
ALPHA19 = ALPHA13+q[9]*qdd[3]+(2.0)*qd[3]*qd[9];
ALPHA39 = qdd[9]+ALPHA33+q[9]*BS93;
OM210 = qd[10]+qd[3];
OMp210 = qdd[10]+qdd[3];
BS910 = -OM210*OM210;
...
BS911 = -OM210*OM210;
ALPHA111 = ALPHA110+q[11]*OMp210+(2.0)*qd[11]*OM210;
ALPHA311 = qdd[11]+ALPHA310+q[11]*BS910;
OM212 = qd[12]+OM210;
...
Cq212 = -trq[2][12]+Cq213+In[5][12]*OMp212+Fs112*l[3][12];
...
Fq110 = Fq111+Fs110;
Fq310 = Fq311+Fs310;
Cq210 = -trq[2][10]+Cq211+q[11]*Fq111+In[5][10]*OMp210+Fs110*l[3][10];
...
Cq27 = -trq[2][7]+Cq28+In[5][7]*OMp27+Fs17*l[3][7];
...
Fq15 = Fq16+Fs15;
Fq35 = Fq36+Fs35;
Cq25 = -trq[2][5]+Cq26+q[6]*Fq16+In[5][5]*OMp25+Fs15*l[3][5];
...
Fq13 = Fq14+Fq19+Fs13;
Fq33 = Fq34+Fq39+Fs33;
Cq23 = -trq[2][3]+Cq24+Cq29+q[4]*Fq14+q[9]*Fq19+qdd[3]*In[5][3];
