...
WP = "../../philippides_py/Walking_Patterns/WP_Dionysos_trajectory_Robotran.csv"
Robotran_robot = "../data/Validations_Dionysos_Robot_Physique/Traj_Robotran.txt"

Simulation_file_D = "../data/Dionysos/" + "trajectory" + "/" + File + ".txt"
WP_D = "../WalkingPatterns/Dionysos_trajectory_Julia.csv"
JuliaRobotics_robot = "../data/Validations_Dionysos_Robot_Physique/Traj_JuliaRobotics.txt"
